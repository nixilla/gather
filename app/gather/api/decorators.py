...
def login_tokens_required(*args, **kwargs):
    return login_required(tokens_required(*args, **kwargs))
...
def tokens_required(function=None, redirect_field_name=None, login_url=None):
    ...
    actual_decorator = user_passes_test(
        lambda u: u.is_authenticated and _user_token_test(u),
