...
from aether.common.conf.urls import generate_urlpatterns, url_pattern as url, include
...
urlpatterns = generate_urlpatterns(kernel=True) + [
    ...
    # ----------------------
    # API
    url(r'', include('gather.api.urls')),
    url(r'^v1/', include('gather.api.urls', namespace='v1')),
