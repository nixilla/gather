...
- `http://core.gather2.local`
- `http://odk.gather2.local`
- `http://sync.gather2.local`
- `http://ui.gather2.local`
...
| nginx             | [NGINX](https://www.nginx.com) to serve protected media files           |
