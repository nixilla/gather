...
class ViewsTest(TestCase):
    ...
    @mock.patch('gather2.ui.api.models.UserTokens.get_or_create_user_app_token')
    ...
    @mock.patch('gather2.ui.api.models.UserTokens.get_or_create_user_app_token', return_value=None)
