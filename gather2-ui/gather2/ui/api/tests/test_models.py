...
class ModelsTests(TestCase):
    ...
    def test__user_tokens__get_app_url(self):
        ...
        self.assertEqual(user_tokens.get_app_url('core'), 'http://kernel-test:9000')
    ...
    def helper__test_user_tokens__validates_app_token(self, user_tokens, app_name, app_property):
        ...
        with mock.patch('gather2.ui.api.models.GATHER_APPS', new={}):
            self.assertFalse(user_tokens.validates_app_token(app_name))
    ...
    @mock.patch('gather2.ui.api.models.GATHER_APPS', new={})
    def test_get_or_create_user_app_token__not_base_url(self):
        for app in MODULES:
            self.assertEqual(get_or_create_user_app_token(self.user, app), None)

    @mock.patch('gather2.ui.api.models.UserTokens.create_app_token', new=mock_return_none)
    @mock.patch('gather2.ui.api.models.UserTokens.validates_app_token', new=mock_return_false)
    def test_get_or_create_user_app_token__not_valid_token(self):
        for app in MODULES:
            self.assertEqual(get_or_create_user_app_token(self.user, app), None)

    @mock.patch('gather2.ui.api.models.UserTokens.get_app_token', new=mock_return_none)
    @mock.patch('gather2.ui.api.models.UserTokens.validates_app_token', new=mock_return_true)
