...
![AWS EC2 Launch](/images/aws-ec2-step3.png) On **Step 3: Configure Instance Details**, Accept all the defaults except for **Auto-assign Public IP** which should be set to **Enable**
